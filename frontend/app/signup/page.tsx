      ...
      <section className="flex flex-1 items-center justify-center px-6 py-16">
        ...
        <div className="w-full max-w-md bg-[#0B1120] p-8 md:p-10 rounded-xl shadow-lg">
          ...
          <p className="text-gray-400 text-center mt-2">
            Create your account and keep your servers awake
          </p>
          ...
          <form className="mt-8 space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 py-3 rounded-md hover:bg-indigo-700"
            >
              Sign up
            </button>
          ...
          <button className="w-full border border-gray-700 py-3 rounded-md flex items-center justify-center gap-2 hover:bg-[#020617]">
